...
[![Star](https://img.shields.io/badge/⭐_Star_Repository-1F1F1F?style=for-the-badge)](https://github.com/tanisbedia/mentra-ai/stargazers)
...
<img src="/assets/preview.png" alt="MentraAI — Product Preview" width="920" />
...
```mermaid
flowchart TD
    A([👩‍🎓 Student]) --> B[🧠 AI Mentor<br/><i>Ask anything, in Hinglish</i>]
    B --> C[📚 Learning<br/><i>Personalized explanations & notes</i>]
    C --> D[⚔️ Quiz Arena<br/><i>Test understanding instantly</i>]
    D --> E[📊 Analytics<br/><i>Strengths, gaps & progress</i>]
    E --> F[🧭 Career Roadmap<br/><i>Skills mapped to real goals</i>]
    F -.->|Continuous feedback loop| B

    style A fill:#0f0f0f,stroke:#7c3aed,color:#fff
    style B fill:#141414,stroke:#7c3aed,color:#fff
    style C fill:#141414,stroke:#7c3aed,color:#fff
    style D fill:#141414,stroke:#7c3aed,color:#fff
    style E fill:#141414,stroke:#7c3aed,color:#fff
    style F fill:#0f0f0f,stroke:#a78bfa,color:#fff
```
...
flowchart TB
    subgraph CLIENT["🖥️ Browser"]
        UI[Next.js App Router UI<br/>React Server Components · Tailwind · Framer Motion]
    end

    subgraph API["⚙️ API Layer"]
        ROUTES[Next.js Route Handlers<br/>Validation · Rate Limiting · Auth Guards]
    end

    subgraph AI["🧠 AI Layer"]
        LLM[LLM Orchestration<br/>Prompt Pipelines · Streaming · Context Memory]
        VISION[Vision & Voice<br/>Image Understanding · Speech I/O]
    end
    ...
    subgraph DATA["🗄️ Supabase"]
        ...
        STORE[Storage<br/>Images & Assets]
    end

    UI <-->|HTTPS / Streaming| ROUTES
    ROUTES --> LLM
    ROUTES --> VISION
    ROUTES <--> AUTH
    ROUTES <--> DB
    ...
    style CLIENT fill:#0f0f0f,stroke:#7c3aed,color:#fff
    style API fill:#141414,stroke:#7c3aed,color:#fff
    style AI fill:#141414,stroke:#a78bfa,color:#fff
    style DATA fill:#0f0f0f,stroke:#3fcf8e,color:#fff
```
...
![Next.js API](https://img.shields.io/badge/Route_Handlers-000000?style=for-the-badge&logo=nextdotjs&logoColor=white)
![Edge Functions](https://img.shields.io/badge/Edge_Functions-3FCF8E?style=for-the-badge&logo=supabase&logoColor=black)

#### Database & Realtime
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=for-the-badge&logo=postgresql&logoColor=white)
![Supabase Realtime](https://img.shields.io/badge/Supabase_Realtime-3FCF8E?style=for-the-badge&logo=supabase&logoColor=black)

#### Authentication
![Supabase Auth](https://img.shields.io/badge/Supabase_Auth-3FCF8E?style=for-the-badge&logo=supabase&logoColor=black)
![JWT](https://img.shields.io/badge/JWT-000000?style=for-the-badge&logo=jsonwebtokens&logoColor=white)

#### AI
![Gemini](https://img.shields.io/badge/Google_Gemini-8E75B2?style=for-the-badge&logo=googlegemini&logoColor=white)
![Streaming](https://img.shields.io/badge/Streaming_Responses-7C3AED?style=for-the-badge)
![Vision](https://img.shields.io/badge/Multimodal_Vision-A78BFA?style=for-the-badge)

#### Deployment
![Vercel](https://img.shields.io/badge/Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)
![Supabase Cloud](https://img.shields.io/badge/Supabase_Cloud-3FCF8E?style=for-the-badge&logo=supabase&logoColor=black)
